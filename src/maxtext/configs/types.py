      ...
      if self.compile_topology:
        try:
          ...
          if spec and spec.platform == "tpu":
            is_tpu = True
            compile_topo = self.compile_topology.lower()
            is_gen7 = "tpu7" in compile_topo or "v7" in compile_topo
        except ValueError:
          pass
      else:
        try:
          ...
          if tpu_devices:
            ...
            is_gen7 = "TPU7" in device_kind or "TPU v7" in device_kind or "TPU7x" in device_kind
            if not is_gen7:
